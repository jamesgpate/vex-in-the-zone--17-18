...
#pragma config(Motor,  port4,           ldr4b,         tmotorVex393HighSpeed_MC29, openLoop, encoderPort, dgtl5)
...
#pragma config(Motor,  port7,           rdr4b,         tmotorVex393HighSpeed_MC29, openLoop, encoderPort, dgtl7)
