...
#pragma config(Sensor, dgtl5,  elbowEnc,       sensorQuadEncoder)
#pragma config(Sensor, dgtl7,  towerEnc,       sensorQuadEncoder)
#pragma config(Sensor, dgtl9,  data,           sensorDigitalOut)
#pragma config(Sensor, dgtl10, clock,          sensorDigitalOut)
#pragma config(Motor,  port1,           claw,          tmotorVex393_HBridge, openLoop)
#pragma config(Motor,  port2,           elbow,         tmotorVex393_MC29, PIDControl, encoderPort, dgtl5)
#pragma config(Motor,  port3,           tower,         tmotorVex393_MC29, PIDControl, encoderPort, dgtl7)
...
#pragma config(MotorPidSetting,  port2,  50, 50, 1000, 5, 10,   33, 45, 60)
#pragma config(MotorPidSetting,  port3,  50, 50, 1000, 5, 10,   33, 45, 60)
...
void pre_auton(){//Selects auton program
	...
	clearLCDLine(1);
	bLCDBacklight = true;
	SensorType[gyro1] = sensorNone;
	SensorType[gyro2] = sensorNone;
	wait1Msec(1500);
	SensorType[gyro1] = sensorGyro;
