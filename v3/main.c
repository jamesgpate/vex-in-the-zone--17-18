...
#pragma config(Sensor, I2C_1,  elbowEnc,       sensorQuadEncoderOnI2CPort,    , AutoAssign )
#pragma config(Motor,  port1,           claw,          tmotorVex393_HBridge, openLoop)
#pragma config(Motor,  port2,           elbow,         tmotorVex393_MC29, PIDControl, encoderPort, I2C_1)
