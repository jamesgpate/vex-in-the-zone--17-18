...
#pragma config(Motor,  port2,           elbow,         tmotorVex393_MC29, openLoop, encoderPort, I2C_2)
#pragma config(Motor,  port3,           tower,         tmotorVex393HighSpeed_MC29, openLoop, encoderPort, I2C_1)
