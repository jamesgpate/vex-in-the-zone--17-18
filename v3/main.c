...
#pragma config(Motor,  port4,           ldr4b,         tmotorVex393TurboSpeed_MC29, PIDControl, encoderPort, dgtl5)
...
#pragma config(Motor,  port7,           rdr4b,         tmotorVex393TurboSpeed_MC29, PIDControl, reversed, encoderPort, dgtl7)
...
#pragma config(MotorPidSetting,  port4,  50, 50, 1000, 5, 10,   33, 45, 60)
#pragma config(MotorPidSetting,  port7,  50, 50, 1000, 5, 10,   33, 45, 60)
