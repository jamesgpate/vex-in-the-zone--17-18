...
#pragma config(Sensor, in3, armGyro, sensorGyro)
...
#pragma config(Sensor, dgtl9, elbowEnc, sensorQuadEncoder)
#pragma config(Motor, port1, claw, tmotorVex393_HBridge, openLoop)
#pragma config(Motor, port2, elbow, tmotorVex393_MC29, openLoop)
#pragma config(Motor, port3, tower, tmotorVex393_MC29, openLoop)
